...
require 'fit/FileId'
require 'fit/FieldDescription'
require 'fit/DeveloperDataId'
require 'fit/EPO_Data'
require 'fit/FileCreator'
require 'fit/DeviceInfo'
require 'fit/SensorSettings'
require 'fit/DataSources'
require 'fit/UserData'
require 'fit/UserProfile'
require 'fit/PhysiologicalMetrics'
require 'fit/Session'
require 'fit/Lap'
require 'fit/Record'
require 'fit/HRV'
require 'fit/HeartRateZones'
require 'fit/Event'
