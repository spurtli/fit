...
#
# = GlobalFitMessages.rb -- Fit - FIT file processing library for Ruby
#
...
module Fit
  GlobalFitMessages = GlobalFitMessageList.new do
    ...
    alt_field 10, 'sport' do
      ...
      field %w[running walking], 'uint32', 'total_strides', unit: 'strides'
    end
    ...
    field 120, 'uint16', 'avg_step_length', scale: 10_000, unit: 'm'
    ...
    field 85, 'uint16', 'stride_length', scale: 10_000, unit: 'm' # guessed
    ...
    alt_field 4, 'manufacturer' do
      field :default, 'uint16', 'product'
      field %w[garmin dynastream dynastream_oem], 'uint16', 'garmin_product', dict: 'garmin_product'
    end
    ...
    alt_field 3, 'activity_type' do
      ...
      field %w[walking running], 'uint32', 'steps', unit: 'steps'
      field %w[cycling swimming], 'uint32', 'strokes', scale: 2, unit: 'strokes'
    end
    ...
    field 5, 'sint32', 'undocumented_field_5'
    field 6, 'sint32', 'undocumented_field_6'
    field 7, 'sint32', 'metmax', scale: 65_536, unit: 'MET'
    ...
    field 29, 'sint32', 'metmax_running', scale: 65_536, unit: 'MET'
    field 34, 'enum', 'undocumented_field_34'
    field 35, 'uint32', 'undocumented_field_35'
    ...
    field 1, 'sint32', 'metmax', scale: 65_536, unit: 'MET'
